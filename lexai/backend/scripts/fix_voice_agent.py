"""Rewrite voice_agent.py to use piper-tts instead of kokoro."""
...
(BACKEND / "agents" / "voice_agent.py").write_text(content, encoding="utf-8")
print("voice_agent.py rewritten to use piper-tts OK")
